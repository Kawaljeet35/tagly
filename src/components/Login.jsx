...
export default function Login({ onLoginSuccess }){
    ...
    return (
        <div className="flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-20 min-h-screen px-4">
            ...
            <div className='w-full lg:w-4/12 flex justify-center'>
                <form className="flex flex-col gap-4 p-8 bg-white rounded-lg" style={{ width: '550px', boxShadow: '0 8px 16px rgba(0, 0, 0, 0.2)' }}>
                    <input 
                        required
                        type="email" 
                    ...
                    <div className='flex justify-center mt-6 mb-6'>
                        <button
                        type="submit"
                        className="bg-blue-600 hover:bg-blue-700 w-max text-white p-3 text-xl font-bold rounded"
